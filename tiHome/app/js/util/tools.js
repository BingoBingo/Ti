  ...
  */
  ...
  KeyBoard:function(input, cursor,vipReduce,vipPayBtn,options){
    ...
    var height = options && options.height;
		...
		//Button
		var btnStr = '<div style="display:none;width:60px;height:28px;background-color:#1FB9FF;';
		...
		var tableStr = '<table id="' + TABLE_ID + '" border="0" cellspacing="0" cellpadding="0">';
			...
			tableStr += '<tr><td style="background-color:#fff;">.</td><td>0</td>';
			tableStr += '<td><div style="background-color:#fff;background-position: center !important;background-size: 0.813333rem 0.48rem !important;background:'+deleteBack+'">&nbsp;</div></td></tr>';
			tableStr += '</table>';
