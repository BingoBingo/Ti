...
render() {
    ...
    var distanceNum = this.state.nextExpNumber*1 - this.state.expNumber *1;
      return (
        <View>
          ...
          <div>
            ...
            <span className="nextRank">距离{this.state.nextRank}:还差{distanceNum}</span>
            <span className="givePointNumber" style={{display:"none"}}>即将获得抵用金:{this.state.givePointNumber}</span>
            </div>
          </div>
          {this.renderMyRank()}
          </Group>
